...
// Revoke destroys tasks on the running `serve`: in-flight operations are
// cancelled, endpoints closed, secrets deleted. Idempotent — revoking an
// unknown or already-gone task succeeds with status "unknown".
